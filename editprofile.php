...
if(isset($_POST['save_data'])){
    ...
    if (move_uploaded_file($tempname, $folder)) {
     ...
     if(!$result){
      ...
      header("location:employeepage.php?emp_id=$empid");        
     }
}
...
<input type="hidden" name="emp_id" class="form-control" value=<?php echo $rows['emp_id'];?> placeholder="Enter the Emp id">
...
<select class="form-select" name="desig" aria-label="Default select example" hidden>
...
<input type="hidden" name="salary" class="form-control" value=<?php echo $rows['salary'];?> placeholder="Enter the salary">
